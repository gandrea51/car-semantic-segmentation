...
def deeplab():
    ...
    model = smp.DeepLabV3Plus(encoder_name=ENCODER, encoder_weights=DATASET, in_channels=3, classes=CLASSES)
    ...
    print(f"\n[START TEST] Test.")
    model = get_model(smp.DeepLabV3Plus, PATH, DEVICE, encoder_name=ENCODER, encoder_weights=None, in_channels=3, classes=CLASSES)
